...
func TestBaseController_FinalizeComponents_NoOp(t *testing.T) {
	ctrl := &concreteController{gvk: controller.GVK{}}
	if err := ctrl.FinalizeComponents(context.Background(), nil); err != nil {
		t.Errorf("BaseController.FinalizeComponents should be a no-op, got %v", err)
	}
}
...
func TestBaseController_AfterDeploy_ReturnsOK(t *testing.T) {
	...
	if !r.OK {
		t.Error("BaseController.AfterDeploy should return OK()")
	}
}
...
func TestBaseController_AfterDeployUnsuccessful_ReturnsOK(t *testing.T) {
	...
	if !r.OK {
		t.Error("BaseController.AfterDeployUnsuccessful should return OK()")
	}
}
...
func TestBaseController_AfterVerify_ReturnsOK(t *testing.T) {
	...
	if !r.OK {
		t.Error("BaseController.AfterVerify should return OK()")
	}
}
...
func TestBaseController_AfterVerifyUnsuccessful_ReturnsOK(t *testing.T) {
	...
	if !r.OK {
		t.Error("BaseController.AfterVerifyUnsuccessful should return OK()")
	}
}

func TestBaseController_ShouldRequeue_DefaultTrue(t *testing.T) {
	// BaseController.ShouldRequeue returns true (keep requeueing until overridden).
...
func TestController_ShouldRequeue_CanBeOverridden(t *testing.T) {
	ctrl := &concreteController{gvk: controller.GVK{}, shouldRequeue: false}
	if ctrl.ShouldRequeue(context.Background(), nil) {
		t.Error("overridden ShouldRequeue=false should return false")
	}
}

func TestController_HasFinalizer_CanBeOverridden(t *testing.T) {
	ctrl := &concreteController{gvk: controller.GVK{}, hasFinalizer: true}
	if !ctrl.HasFinalizer() {
		t.Error("overridden HasFinalizer=true should return true")
	}
}

func TestController_Finalizer_CanBeOverridden(t *testing.T) {
	ctrl := &concreteController{
		gvk:          controller.GVK{Group: "g", Version: "v", Kind: "K"},
		hasFinalizer: true,
		finalizerStr: "finalizers.k.g",
	}
